...
- [x] ISS-4-n2rzx3. create-plan.md's frontmatter template omits the required author key
...
- [x] ISS-5-7sal1s. create-issues.md's frontmatter template omits the required author key
...
- [x] ISS-6-nr0bag. fc-issue-list/SKILL.md's own documented frontmatter example omits author, disagreeing with CONVENTIONS.md
...
- [x] ISS-7-40lthe. The four tasks-from-plan/tasks-from-issues templates never spell out the author key, unlike create-plan.md and create-issues.md
